...
export const CAMPAIGN_ENCOUNTERS = {
  1: {
    ...
    /**
     * Director catalog: first entry with matching `room` wins on room entry.
     * Extra fields (trigger, objective, enemies, …) are Phase 1 spec for tooling and later runtime.
     */
    encounters: [
      {
        id: 'b01_west_service',
        room: 'west_service_connector',
        label: 'West service strip',
        trigger: { type: 'enter_room', room: 'west_service_connector' },
        objective: { type: 'transit', target: null },
      ...
      {
        id: 'b01_east_flank',
        room: 'east_flank_connector',
        label: 'East flank approach',
        trigger: { type: 'enter_room', room: 'east_flank_connector' },
        objective: { type: 'transit', target: null },
        lockdown: { doors: [], soft: false },
        enemies: [],
        reinforcements: [],
      ...
      },
      {
        id: 'b01_dock_intake',
        room: 'dock_intake',
        label: 'Dock intake contact',
        trigger: { type: 'enter_room', room: 'dock_intake' },
        ...
        enemies: [
          {
            ...
            type: 'scout',
            role: 'lookout',
            spawn: { cell: 'FE', x: 14, z: 17 },
            facing: Math.PI,
            behavior: 'patrol_then_alarm',
            patrol: 'fe_compression_loop',
            cover: 'east_stack',
            alertLink: ['b01_soldier_fc', 'b01_heavy_fw'],
          },
          {
            id: 'b01_soldier_fc',
            type: 'soldier',
            role: 'patrol',
            spawn: { cell: 'FC', x: 1, z: 13.5 },
            facing: -Math.PI / 2,
            behavior: 'patrol_lane',
            patrol: 'intake_center_beat',
            cover: 'intake_apron',
            alertLink: ['b01_heavy_fw'],
          },
          {
            id: 'b01_heavy_fw',
            type: 'heavy',
            role: 'anchor',
            spawn: { cell: 'FW', x: -12.5, z: 15 },
            facing: 0,
            behavior: 'hold_angle',
            preferredState: 'HOLD_CORNER',
            cover: 'west_lane_fork',
            alertLink: [],
          },
        ],
        reinforcements: [],
      ...
      {
        id: 'b01_mid_west_wedge',
        room: 'mid_lane_west',
        label: 'Relay threshold wedge',
        trigger: { type: 'enter_room', room: 'mid_lane_west' },
        objective: { type: 'transit', target: null },
        lockdown: { doors: [], soft: false },
        enemies: [],
        reinforcements: [],
      ...
      {
        id: 'b01_mid_spine',
        room: 'mid_lane_center',
        label: 'Spine crossing',
        trigger: { type: 'enter_room', room: 'mid_lane_center' },
        objective: { type: 'eliminate_hostiles', target: null },
        lockdown: { doors: [], soft: false },
        enemies: [
          {
            ...
            type: 'soldier',
            role: 'patrol',
            spawn: { cell: 'FC', x: 0, z: 2 },
            facing: Math.PI,
            behavior: 'peek_from_cover',
            patrol: 'spine_doorline',
            cover: 'spine_pinch',
            alertLink: [],
          },
        ],
      ...
      {
        id: 'b01_alarm_relay',
        room: 'alarm_relay_room',
        label: 'Relay floor hold',
        trigger: { type: 'enter_room', room: 'alarm_relay_room' },
      ...
      },
      {
        ...
        trigger: { type: 'enter_room', room: 'drum_lane' },
        objective: { type: 'eliminate_hostiles', target: null },
        lockdown: { doors: [], soft: false },
        enemies: [
          {
      ...
      },
      {
        ...
        room: 'relay_cage',
        label: 'Loading cage',
        trigger: { type: 'enter_room', room: 'relay_cage' },
        objective: { type: 'eliminate_hostiles', target: null },
        lockdown: { doors: [], soft: false },
        enemies: [
          {
      ...
      },
      {
        id: 'b01_foreman_read',
        room: 'foreman_cage',
        label: 'Catwalk cage read',
        trigger: { type: 'enter_room', room: 'foreman_cage' },
        objective: { type: 'eliminate_hostiles', target: null },
        lockdown: { doors: [], soft: false },
        enemies: [
          {
    ...
    director: {
      version: 1,
      entryRoom: 'dock_intake',
      flowRef: 'flow',
      triggerDefault: 'enter_room',
      completionFallback: 'zone_clear_legacy',
      /** Meso gates: zone N combat clear + these encounters complete before `openZoneDoor(N)`. */
      zoneDoorRequires: {
        0: { encounterIds: ['b01_dock_intake'], alsoRequireZoneClear: true },
        1: { encounterIds: ['b01_mid_spine', 'b01_alarm_relay', 'b01_drum_flank'], alsoRequireZoneClear: true },
      },
      objectives: [
        {
          id: 'reach_mid_spine',
    ...
    authoredSpawns: {
      frontZone: [
        { id: 'b01_scout_fe_lane', type: 'scout', roomId: 'dock_intake', role: 'lookout', x: 14, z: 17 },
        { id: 'b01_soldier_fc', type: 'soldier', roomId: 'dock_intake', role: 'patrol', x: 1, z: 13.5 },
        { id: 'b01_heavy_fw', type: 'heavy', roomId: 'dock_intake', role: 'anchor', x: -12.5, z: 15 },
      ],
      middleZone: [
        { id: 'b01_mw_desk', type: 'soldier', roomId: 'alarm_relay_room', role: 'anchor', x: -14, z: 2.5 },
        { id: 'b01_me_lane', type: 'scout', roomId: 'drum_lane', role: 'flanker', x: 14.5, z: 0 },
        { id: 'b01_fc_doorline', type: 'soldier', roomId: 'mid_lane_center', role: 'patrol', x: 0, z: 2 },
      ],
      backZone: [
        { id: 'b01_bw_hold', type: 'soldier', roomId: 'relay_cage', role: 'patrol', x: -13, z: -16 },
        { id: 'b01_bc_heavy', type: 'heavy', roomId: 'relay_cage', role: 'anchor', x: -2, z: -17 },
        { id: 'b01_bc_rifle', type: 'soldier', roomId: 'relay_cage', role: 'patrol', x: 3, z: -14 },
        { id: 'b01_be_scout', type: 'scout', roomId: 'foreman_cage', role: 'flanker', x: 13.5, z: -17 },
      ],
    },
  },
};
